...
class userActions(Generic[_PrismaModelT]):
    ...
    async def create(
        ...
        user = await user.prisma().create(
            data={
                ...
                'city': 'bbehjachib',
                'state': 'cadfabfehe',
                'first_name': 'dgiiaaijj',
                'last_name': 'bfaiacjjfc',
                'user_id': 'eigcfgbif',
            },
        )
        ```
        ...
        total = await user.prisma().create_many(
            data=[
                ...
                },
                {
                    ...
                    'city': 'bbejhfidcb',
                    'state': 'bgeecijdgg',
                    'first_name': 'bdiicjafbj',
                    'last_name': 'bgehebiafc',
                    'user_id': 'bghffegacj',
                },
            ],
    ...
    async def find_many(
        ...
        # find the first 5 user records ordered by the artists field
    ...
    async def find_first(
        ...
        -------
        ```py
        # find the second user record ordered by the city field
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second user record ordered by the state field
...
class reviewActions(Generic[_PrismaModelT]):
    ...
    async def query_first(
        ...
        *args
        ...
        user = await review.prisma().query_first(
            'SELECT * FROM review WHERE artist = $1',
            'igbehcbab',
        )
        ```
        """
    ...
    async def find_many(
        ...
        # find the first 5 review records ordered by the review field
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second review record ordered by the images field
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group review records by review values
        # and count how many records are in each group
