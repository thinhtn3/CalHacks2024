...
SCHEMA_PATH = Path('/Users/andy/calhacks/CalHacks2024/backend/prisma/schema.prisma')
...
class Prisma(AsyncBasePrisma):
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/Users/andy/calhacks/CalHacks2024/backend/prisma/schema.prisma',
        }
