...
SCHEMA_PATH = Path('/Users/andy/calhacks/festival_yelp/calhacks/calhacks/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin-arm64': '/Users/andy/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-darwin-arm64'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    reviews: 'actions.reviewsActions[models.reviews]'
    ...
    def __init__(
        ...
        *,
        ...
        self.reviews = actions.reviewsActions[models.reviews](self, models.reviews)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/Users/andy/calhacks/festival_yelp/calhacks/calhacks/prisma/schema.prisma',
        }
...
class Batch:
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.reviews = reviewsBatchActions(self)
