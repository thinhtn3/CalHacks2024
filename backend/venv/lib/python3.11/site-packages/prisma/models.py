...
class user(bases.Baseuser):
    ...
    @field_validator('artists', 'genres', pre=True, allow_reuse=True)
    @classmethod
...
class reviews(bases.Basereviews):
    ...
    def create_partial(
        ...
        try:
            ...
            if relations:
                raise ValueError('Model: "reviews" has no relational fields.')
        except KeyError as exc:
            raise ValueError(
...
_reviews_relational_fields: Set[str] = set()  # pyright: ignore[reportUnusedVariable]
